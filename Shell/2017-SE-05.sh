#!/bin/bash
#Напишете скрипт, който получава два задължителни позиционни параметра — директория и низ. Сред файловете в директорията би могло да има такива,
#чиито имена имат структура vmlinuz-x.y.z-arch, където:

#vmlinuz е константен низ;
#тиретата "-" и точките "." присъстват задължително;
#x е число, version; y — major revision; z — minor revision;
